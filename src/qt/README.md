...
Used to process BIP21 and BIP70 (see https://github.com/bitcoinevolutions/bitcoin/pull/11622) payment URI / requests. Also handles URI based application switching (e.g. when following a bitcoin:... link from a browser).
